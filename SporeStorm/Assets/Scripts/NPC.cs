...
public class NPC : MonoBehaviour
{
    ...
    {
        characterData.SetFlag(flag, value);
    }
    ...
    private void LoadCharacterData()
    {
        ...
        {
            Debug.LogError($"Missing characterdata file for {characterDataFile}");
        }
        ...
        {
            Debug.LogError($"LOADDATA: character data is empty for {characterDataFile}");
        }
    }
}
