...
- You walk forward more, noticing a lone mechanic waiting outside what appears to be an abandoned garage.
    ...
    "What are you still doing here? They sent out the evacuation notice hours ago."
    * ["The same could be said about you, y'know."]
    - "Fair enough. What's the problem, anyway? You don't seem to rushed to get out of here."
        * ["I just find this all hard to believe. A mutant storm full of spores?"]
            I wouldn't be too sure about that. I've seen some of the people they've been wheeling across the street, and it looks pretty bad.
            "Rashes and blisters all over their face, some of them throwing up everywhere too."
    ...
    - * ["God, that's awful. Maybe the news was right for once. But, if you saw it all, why aren't you leaving?"]
        "Can't, the government shut down the buses. I got left here to tough it out."
            ...
            * * * ["No, please, I insist. No decent human could leave someone else here stranded."]
